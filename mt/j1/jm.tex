...
\begin{enumerate}
	...
	\item The angle between the straight lines, whose direction cosines are given by the equations $2\vec{l} + 2\vec{m} - \vec{n} = 0$ and $\vec{mn} + \vec{nl} + \vec{lm} =0$, is : 
	\begin{enumerate}
	\begin{multicols}{2}
		\item $\frac{\pi}{2}$ 
...
\item If the solution curve of the differential equation $\brak{2x - 10y^3}dy + ydx = 0$, passes through the points $  \brak{0,1}$ and $\brak{2,\beta}$, then $\beta$ is a root of the equation: 
	...
	\end{multicols}
	\end{enumerate}
\item Let $\vec{A}\brak{a, 0}$, $\vec{B}\brak{b, 2b + 1}$ and $\vec{C}\brak{0, b}, b \neq 0, |b| \neq 1$, be points such that the area of the triangle $\vec{ABC}$ is $1$ sq. unit, then the sum of all possible values of $a$ is: 
